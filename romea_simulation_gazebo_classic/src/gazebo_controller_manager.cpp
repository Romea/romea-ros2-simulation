...
void GazeboControllerManager::init_services()
{
  ...
  list_controllers_service_ = create_service<controller_manager_msgs::srv::ListControllers>(
    "~/list_controllers", std::bind(
      &GazeboControllerManager::list_controllers_srv_cb, this, _1,
      _2),
  ...
  list_controller_types_service_ =
    ...
    std::bind(&GazeboControllerManager::list_controller_types_srv_cb, this, _1, _2),
    rmw_qos_profile_services_default, best_effort_callback_group_);
  list_hardware_interfaces_service_ =
    create_service<controller_manager_msgs::srv::ListHardwareInterfaces>(
    "~/list_hardware_interfaces",
    std::bind(&GazeboControllerManager::list_hardware_interfaces_srv_cb, this, _1, _2),
    rmw_qos_profile_services_default, best_effort_callback_group_);
  load_controller_service_ = create_service<controller_manager_msgs::srv::LoadController>(
    "~/load_controller",
    std::bind(&GazeboControllerManager::load_controller_service_cb, this, _1, _2),
    rmw_qos_profile_services_default, best_effort_callback_group_);
  configure_controller_service_ = create_service<controller_manager_msgs::srv::ConfigureController>(
    "~/configure_controller",
    std::bind(&GazeboControllerManager::configure_controller_service_cb, this, _1, _2),
    rmw_qos_profile_services_default, best_effort_callback_group_);
  load_and_configure_controller_service_ =
    ...
    std::bind(&GazeboControllerManager::load_and_configure_controller_service_cb, this, _1, _2),
    rmw_qos_profile_services_default, best_effort_callback_group_);
  load_and_start_controller_service_ =
    ...
    std::bind(&GazeboControllerManager::load_and_start_controller_service_cb, this, _1, _2),
    rmw_qos_profile_services_default, best_effort_callback_group_);
  configure_and_start_controller_service_ =
    ...
    std::bind(&GazeboControllerManager::configure_and_start_controller_service_cb, this, _1, _2),
    rmw_qos_profile_services_default, best_effort_callback_group_);
  reload_controller_libraries_service_ =
    create_service<controller_manager_msgs::srv::ReloadControllerLibraries>(
    "~/reload_controller_libraries",
    std::bind(&GazeboControllerManager::reload_controller_libraries_service_cb, this, _1, _2),
    rmw_qos_profile_services_default, best_effort_callback_group_);
  switch_controller_service_ = create_service<controller_manager_msgs::srv::SwitchController>(
    "~/switch_controller",
    std::bind(&GazeboControllerManager::switch_controller_service_cb, this, _1, _2),
    rmw_qos_profile_services_default, best_effort_callback_group_);
  unload_controller_service_ = create_service<controller_manager_msgs::srv::UnloadController>(
    "~/unload_controller",
    std::bind(&GazeboControllerManager::unload_controller_service_cb, this, _1, _2),
    rmw_qos_profile_services_default, best_effort_callback_group_);
}

controller_interface::ControllerInterfaceSharedPtr GazeboControllerManager::load_controller(
...
controller_interface::return_type GazeboControllerManager::unload_controller(
  const std::string & controller_name)
{
  std::lock_guard<std::recursive_mutex> guard(rt_controllers_wrapper_.controllers_lock_);
  std::vector<controller_manager::ControllerSpec> & to = rt_controllers_wrapper_.get_unused_list(
    guard);
  const std::vector<controller_manager::ControllerSpec> & from =
  ...
  std::vector<controller_manager::ControllerSpec> & new_unused_list =
...
std::vector<controller_manager::ControllerSpec> GazeboControllerManager::get_loaded_controllers()
const
{
  std::lock_guard<std::recursive_mutex> guard(rt_controllers_wrapper_.controllers_lock_);
...
controller_interface::return_type GazeboControllerManager::configure_controller(
  const std::string & controller_name)
{
...
controller_interface::return_type GazeboControllerManager::switch_controller(
...
controller_interface::ControllerInterfaceSharedPtr GazeboControllerManager::add_controller_impl(
  const controller_manager::ControllerSpec & controller)
{
  // lock controllers
  std::lock_guard<std::recursive_mutex> guard(rt_controllers_wrapper_.controllers_lock_);
  ...
  static std::string toto = "toto";
  std::cout << " toto " << toto;
  toto = get_namespace();
  std::cout << " toto " << toto << std::endl;

  std::string ns_arg = std::string("__ns:=") + get_namespace();
  std::vector<const char *> argv = {"--ros-args", RCL_REMAP_FLAG, ns_arg.c_str()};
  ...
  auto rcl_context = get_node_base_interface()->get_context()->get_rcl_context();
...
void GazeboControllerManager::manage_switch()
{
...
void GazeboControllerManager::stop_controllers()
{
  std::vector<controller_manager::ControllerSpec> & rt_controller_list =
...
void GazeboControllerManager::start_controllers()
{
  std::vector<controller_manager::ControllerSpec> & rt_controller_list =
    rt_controllers_wrapper_.update_and_get_used_by_rt_list();
  for (const auto & request : start_request_) {
    ...
    for (const auto & command_interface : command_interface_names) {
      ...
      try {
        ...
        RCLCPP_ERROR(
          get_logger(), "Can't activate controller '%s': %s", request.c_str(),
          e.what());
        assignment_successful = false;
        break;
      }
...
void GazeboControllerManager::start_controllers_asap()
{
  //  https://github.com/ros-controls/ros2_control/issues/263
  start_controllers();
}

void GazeboControllerManager::list_controllers_srv_cb(
...
void GazeboControllerManager::list_controller_types_srv_cb(
...
void GazeboControllerManager::list_hardware_interfaces_srv_cb(
...
void GazeboControllerManager::load_controller_service_cb(
  ...
  std::shared_ptr<controller_manager_msgs::srv::LoadController::Response> response)
{
  // lock services
  RCLCPP_DEBUG(
    get_logger(), "loading service called for controller '%s' ",
    request->name.c_str());
  std::lock_guard<std::mutex> guard(services_lock_);
...
void GazeboControllerManager::configure_controller_service_cb(
...
void GazeboControllerManager::load_and_configure_controller_service_cb(
...
void GazeboControllerManager::load_and_start_controller_service_cb(
...
void GazeboControllerManager::configure_and_start_controller_service_cb(
...
void GazeboControllerManager::reload_controller_libraries_service_cb(
...
void GazeboControllerManager::switch_controller_service_cb(
...
void GazeboControllerManager::unload_controller_service_cb(
...
std::vector<std::string> GazeboControllerManager::get_controller_names()
{
...
void GazeboControllerManager::read() {resource_manager_->read();}

controller_interface::return_type GazeboControllerManager::update(
...
void GazeboControllerManager::write() {resource_manager_->write();}

std::vector<controller_manager::ControllerSpec> &
GazeboControllerManager::RTControllerListWrapper::update_and_get_used_by_rt_list()
{
...
std::vector<controller_manager::ControllerSpec> & GazeboControllerManager::RTControllerListWrapper::
get_unused_list(
...
const std::vector<controller_manager::ControllerSpec> & GazeboControllerManager::
RTControllerListWrapper::get_updated_list(
...
void GazeboControllerManager::RTControllerListWrapper::switch_updated_list(
  const std::lock_guard<std::recursive_mutex> &)
{
  if (!controllers_lock_.try_lock()) {
    throw std::runtime_error("controllers_lock_ not owned by thread");
...
int GazeboControllerManager::RTControllerListWrapper::get_other_list(int index) const
{
  return (index + 1) % 2;
}

void GazeboControllerManager::RTControllerListWrapper::wait_until_rt_not_using(
...
unsigned int GazeboControllerManager::get_update_rate() const {return update_rate_;}
